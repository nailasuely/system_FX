    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        try {
            if(DAO.getOrdemServicoDAO().ordersByTechnician(HomeController.getCpfTecnico())!=null){
                try {
                    for (OrdemServico ordem: DAO.getOrdemServicoDAO().ordersByTechnician(HomeController.getCpfTecnico())) {
                ...
                alertMessageController.showAlertMensage("Você esta sem ordens de serviço");
            }
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
